...
java -cp "./IterativeParallelismTest.jar:./lib/*:./out/production/HW2.6" info.kgeorgiy.java.advanced.concurrent.Tester list ru.ifmo.ctddev.zemskov.concurrent.IterativeParallelism $1
